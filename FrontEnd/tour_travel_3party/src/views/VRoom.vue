  ...
  <div class="list-template">
    <div class="header d-flex">
        ...
        <div class="option-button d-flex">
            ...
            <div class="btn" @click="showFormRoom">Thêm mới</div>
        </div>
    </div>
...
import TheRoomForm from '../components/form/TheRoomForm.vue'
export default {
    components: { BaseInput, BaseNavigationPage, TheRoomForm},
    data(){
        return{
            totalRecord : 500,
            totalPage: 5,
